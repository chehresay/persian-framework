...
class PersianFramework_Field_Email {
    ...
    public function render() {
        ...
        $placeholder = isset($this->field['placeholder']) ? $this->field['placeholder'] : 'example@domain.com';
        $required = isset($this->field['required']) && $this->field['required'] ? 'required' : '';
        ?>

        <div class="pf-field-wrapper pf-field-email">
